		...
		describe('#apply() to approve', () => {
			...
			it('should create an application', (done) => {
				...
				affiliateApi.applicationApply({
						...
						'contact.address': 'test-apply-address',
						'contact.suite': 'test-apply-suite',
						'contact.city': 'test-apply-city',
						'contact.state': 'test-apply-state',
						'contact.postalCode': '12345',
						'contact.country': 'test-apply-country',
						'company.company': 'test-apply-company',
						'company.taxId': 'test-apply-tax-id',
						'company.taxClass': 'llc',
						'company.payableTo': 'contact',
						'company.payBy': 'check',
						'company.address': 'test-apply-company-address',
						'company.suite': 'test-apply-company-suite',
						'company.city': 'test-apply-company-city',
						'company.state': 'test-apply-company-state',
						'company.postalCode': '67890',
						'company.country': 'test-apply-company-country',
